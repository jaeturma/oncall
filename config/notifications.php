    ...
    */
    'events' => [
        ...
        'earning_reversed' => [
            ...
            'default_title' => 'A job earning was reversed',
            'default_body' => 'PHP {{amount}} was removed from your wallet: {{reason}}',
        ],
        'refund_completed' => [
            'category' => NotificationCategory::Wallet,
            'mandatory' => true,
            'sms_fallback' => false,
            'placeholders' => ['amount'],
            'default_title' => 'Refund completed',
            'default_body' => 'PHP {{amount}} has been refunded on your job.',
        ],
        'refund_rejected' => [
            'category' => NotificationCategory::Wallet,
            'mandatory' => false,
            'sms_fallback' => false,
            'placeholders' => ['reason'],
            'default_title' => 'Refund request declined',
            'default_body' => 'Your refund request was declined: {{reason}}',
        ],
    ],
];
