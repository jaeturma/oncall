...
{
    public function store(StoreUserReportRequest $request, Job $job): JsonResponse
    {
        ...
        return response()->json(['message' => 'Safety report submitted for admin review. No enforcement is automatic.'], 201);
    }
}
