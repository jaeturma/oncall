...
class JobController extends Controller
{
    public function index(Request $request): JsonResponse
    {
        ...
        $jobs = Job::query()
            ->with(['serviceRequest.service:id,name', 'serviceRequest.barangay:id,name', 'serviceFinder:id,name', 'provider:id,name'])
