...
<article {{ $attributes->merge(['class' => 'overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200']) }}>
    ...
    <div class="grid gap-5 p-6 sm:grid-cols-[5rem_1fr]">
        ...
        <div class="min-w-0">
            ...
            @unless($reveal)<p class="mt-4 text-sm text-slate-500">Name and contact details are hidden. Sign in or register as a verified Service Finder to request this provider.</p>@endunless
        </div>
    </div>
</article>
